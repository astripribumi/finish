			...
			<fieldset>				
				<table class="nostyle">
					<tr>
						...
						<td><input type="text" value="<?=$nm_cat;?>" size="40" name="CategoryName" 
						class="input-text" required="required" /></td>
					</tr>					
					<tr>
						<td class="va-top">Description:</td>
						<td><textarea cols="75" rows="7" required="required" name="Description" 
						class="input-text"><?=$desk;?></textarea></td>
					</tr>
					<tr>
						<!--  form utk upload -->
